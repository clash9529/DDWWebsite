// Transcrypt'ed from Python, 2021-11-25 19:02:22
var random = {};
...
export var compute_task1 = function () {
	var py_case = document.getElementByName ('case').value;
	print (py_case);
	document.getElementById ('result').innerHTML = py_case;
};
